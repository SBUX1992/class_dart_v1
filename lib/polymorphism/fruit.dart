...
void main() {
  ...
  // Banana banana1 = ((Banana) fruits[0]).origin; <- java에서 다운캐스팅(형변환 방법)
  Banana banana1 = fruits[0] as Banana; // 다운캐스팅 형태
  print(banana1.origin);  // 다운캐스팅 후 origin 변수 선언 가능
  // as : 상속 관계에서 형 변환을 처리할 수 있음.
